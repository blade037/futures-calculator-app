...
import { Calculator, TrendingUp, TrendingDown, DollarSign, Percent, Info, MapPin, Save, Check, X } from 'lucide-react'
...
const TaxCalculator = () => {
  ...
  const SHORT_TERM_RATE = 0.38
  const CA_STATE_RATE = 0.133
  ...
  const handleSaveCalculation = async () => {
    ...
    try {
      await taxDB.saveCalculation(results, notes)
      setSaveSuccess(true)
